...
const Home = () => {
  ...
  return (
    ...
    <div class="Types">
        <div class="Type">
            <img src="./public/Content/images2/Anxiety.png" class="TypeI" width="100px" data-aos="flip-left" loading='lazy'/>
        ...
        <div class="Type">
            <img src="./public/Content/images2/Mood.png" class="TypeI" width="100px" data-aos="flip-up" loading='lazy'/>
            <p>Mood Disorder</p>
            <div className='description'>
        ...
        <div class="Type">
            <img src="./public/Content/images2/Psychotic.png" class="TypeI" width="100px" data-aos="flip-right" loading='lazy'/>
        ...
        <div class="Type">
            <img src="./public/Content/images2/Personality.png" class="TypeI" width="100px" data-aos="flip-left" loading='lazy'/>
        ...
        <div class="Type">
            <img src="./public/Content/images2/Eating.png" class="TypeI" width="100px" data-aos="flip-up" loading='lazy'/>
            <p>Eating Disorder</p>
            <div className='description'>
        ...
        <div class="Type">
            <img src="./public/Content/images2/Trauma-related.png" class="TypeI" width="100px" data-aos="flip-right" loading='lazy'/>
        ...
        <div class="Type">
            <img src="./public/Content/images2/Substance-related-Addictive.png" class="TypeI" width="100px" data-aos="flip-left" loading='lazy'/>
        ...
        <div class="Type">
            <img src="./public/Content/images2/Neurodevelopment.png" class="TypeI" width="100px" data-aos="flip-up" loading='lazy'/>
        ...
        <div class="Type">
            <img src="./public/Content/images2/Dissociative.png" class="TypeI" width="100px" data-aos="flip-right" loading='lazy'/>
        ...
        <div class="Type">
            <img src="./public/Content/images2/Somatoform.png" class="TypeI" width="100px" data-aos="flip-left" loading='lazy'/>
        ...
        <div class="Type">
            <img src="./public/Content/images2/Sleep.png" class="TypeI" width="100px" data-aos="flip-up" loading='lazy'/>
            <p>Sleep Disorder</p>
            <div className='description'>
        ...
        <div class="Type">
            <img src="./public/Content/images2/Neurocognitive.png" class="TypeI" width="100px" data-aos="flip-right" loading='lazy'/>
