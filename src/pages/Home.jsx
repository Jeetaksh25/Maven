...
const Home = () => {
  ...
  return (
    <>
      <h1 align="center" style={{ fontSize: "50px",marginTop: "5px",display: "block", justifyContent: "center", alignItems: "center"}}>Maven, Your Friend</h1>
      <div className='intro'>
        ...
        <div className='introR'>
          ...
          <Button  onClick={scrollToSection} className='GetStarted'>Get Started</Button>
        </div>
      </div>
    ...
    <div class="Blocks1">
        <div class="Block1" data-aos="zoom-in">
            <img src="./public/Content/images/Identifying problems.jpg" width="250px" height="200px" class="Block1img"/>
            <div><p class="Block1text">Identifying your problems</p></div>
        </div>
        <div class="Block1" data-aos="zoom-in">
            <img src="./public/Content/images/EasyGuide.jpg" width="250px" height="200px" class="Block1img"/>
            <div><p class="Block1text">Easy Guide</p></div>
        </div>
        <div class="Block1" data-aos="zoom-in">
            <img src="./public/Content/images/Daily challanges.jpg" width="250px" height="200px" class="Block1img"/>
            <div><p class="Block1text">Daily Challenges</p></div>
        </div>
        <div class="Block1" data-aos="zoom-in">
            <img src="./public/Content/images/RewardsforProgress.jpg" width="250px" height="200px" class="Block1img"/>
            <div><p class="Block1text">Rewards for your progress</p></div>
        </div>
    </div>

    <div class="TypesH">
        <h1 style={{marginTop:"70px",marginBottom:"40px"}}>Types of mental health issues</h1>
    </div>

    <div class="Types">
        <div class="Type">
            <img src="./public/Content/images2/Anxiety.png" class="TypeI" width="100px" data-aos="flip-left"/>
        ...
        <div class="Type">
            <img src="./public/Content/images2/Mood.png" class="TypeI" width="100px" data-aos="flip-up"/>
            <p>Mood Disorder</p>
            <div className='description'>
        ...
        <div class="Type">
            <img src="./public/Content/images2/Psychotic.png" class="TypeI" width="100px" data-aos="flip-right"/>
        ...
        <div class="Type">
            <img src="./public/Content/images2/Personality.png" class="TypeI" width="100px" data-aos="flip-left"/>
        ...
        <div class="Type">
            <img src="./public/Content/images2/Eating.png" class="TypeI" width="100px" data-aos="flip-up"/>
            <p>Eating Disorder</p>
            <div className='description'>
        ...
        <div class="Type">
            <img src="./public/Content/images2/Trauma-related.png" class="TypeI" width="100px" data-aos="flip-right"/>
        ...
        <div class="Type">
            <img src="./public/Content/images2/Substance-related-Addictive.png" class="TypeI" width="100px" data-aos="flip-left"/>
        ...
        <div class="Type">
            <img src="./public/Content/images2/Neurodevelopment.png" class="TypeI" width="100px" data-aos="flip-up"/>
        ...
        <div class="Type">
            <img src="./public/Content/images2/Dissociative.png" class="TypeI" width="100px" data-aos="flip-right"/>
        ...
        <div class="Type">
            <img src="./public/Content/images2/Somatoform.png" class="TypeI" width="100px" data-aos="flip-left"/>
        ...
        <div class="Type">
            <img src="./public/Content/images2/Sleep.png" class="TypeI" width="100px" data-aos="flip-up"/>
            <p>Sleep Disorder</p>
            <div className='description'>
        ...
        <div class="Type">
            <img src="./public/Content/images2/Neurocognitive.png" class="TypeI" width="100px" data-aos="flip-right "/>
    ...
    <div className='QuizC' id="targetSection">
      ...
      <p>This is a simple quiz like test that will help you understand your mental health. And give you a personalized guide.</p>
      <Link to="/quiz" align>
        <Button className="GetStarted">Start Quiz</Button>
      </Link>
    </div>
